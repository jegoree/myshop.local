...
/**
 * 
 * This model will work with users details 
 * 
 */
 ...
 * 
 * @return array of new users details 
 * 
 */
...
function registerNewUser($email, $pwdMD5, $name, $phone, $adress){
	...
	$pwdMD5	= htmlspecialchars(mysqli_real_escape_string($db, $pwdMD5));
...
/**
 * 
 *  Function checks if email is registered
 * 
 *  @param string email
 *  @return array - user from table or an empty array
 * 
 */
